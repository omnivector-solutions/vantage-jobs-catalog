...
export REMOTE_APPTAINER_IMAGE="oras://public.ecr.aws/omnivector-solutions/hpcg-benchmark:latest"
export LOCAL_APPTAINER_IMAGE=$APPTAINER_IMAGES_DIR/vantage-jobs-catalog-hpcg.sif
